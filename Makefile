...
#    executable.
#
readaline: readaline.o testReadaline.o wordCleanup.o
	$(CC) $(LDFLAGS) -o readaline readaline.o testReadaline.o \
	wordCleanup.o $(LDLIBS)

simlines: simlines.o readaline.o wordCleanup.o
	$(CC) $(LDFLAGS) -o simlines  simlines.o readaline.o wordCleanup.o \
	$(LDLIBS)